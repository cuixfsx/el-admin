<template>
  <div class="app-container">
    ...
    <!--表格渲染-->
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;" @filter-change="handleFilterChange">
      ...
      <el-table-column label="状态" prop="enabled" :filters="tableStatus" :filter-method="filterHandler">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      tableStatus: [{ text: '异常' , value: '异常' },{ text: '正常' , value: '正常' }],
